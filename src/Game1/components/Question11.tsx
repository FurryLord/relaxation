    ...
    return (
        <body style={body}>
            ...
            <div style={block}>
                ...
                <div style={little_box_now} id="b11">11</div>
            ...
            <div style={box}>
                ...
                <div style={answer}>
                    <div style={box_answer} onClick={() => navigate('/home/Question12')}>
                        <button style={btn}>{qu.q11.answers.a}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q11.answers.b}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q11.answers.c}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q11.answers.d}</button>
                    </div>
                </div>
            </div>
