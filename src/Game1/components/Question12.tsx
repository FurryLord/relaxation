    ...
    return (
        <body style={body}>
            ...
            <div style={block}>
                ...
                <div style={little_box_now} id="b12">12</div>
            ...
            <div style={box}>
                ...
                <div style={answer}>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q12.answers.a}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/Question13')}>
                        <button style={btn}>{qu.q12.answers.b}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q12.answers.c}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q12.answers.d}</button>
                    </div>
                </div>
            </div>
