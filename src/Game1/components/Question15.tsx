    ...
    return (
        <body style={body}>
            ...
            <div style={block}>
                ...
                <div style={little_box_pass} id="b10">10</div>
                <div style={little_box_pass} id="b11">11</div>
                <div style={little_box_pass} id="b12">12</div>
                <div style={little_box_pass} id="b13">13</div>
                <div style={little_box_pass} id="b14">14</div>
                <div style={little_box_now} id="b15">15</div>
            </div>
            <div style={box}>
                <div style={question}>
                    <p>Question</p>
                ...
                <div style={answer}>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q15.answers.a}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q15.answers.b}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/Win')}>
                        <button style={btn}>{qu.q15.answers.c}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q15.answers.d}</button>
                    </div>
                </div>
            </div>
