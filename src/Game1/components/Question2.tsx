    ...
    return (
        <body style={body}>
            ...
            <div style={block}>
                ...
                <div style={little_box_now} id="b2">2</div>
            ...
            <div style={box}>
                ...
                <div style={answer}>
                    <div style={box_answer} onClick={() => navigate('/home/Question3')}>
                        <button style={btn}>{qu.q2.answers.a}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q2.answers.b}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q2.answers.c}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q2.answers.d}</button>
                    </div>
                </div>
            </div>
