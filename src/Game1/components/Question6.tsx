    ...
    return (
        <body style={body}>
            ...
            <div style={block}>
                ...
                <div style={little_box_now} id="b6">6</div>
            ...
            <div style={box}>
                ...
                <div style={answer}>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q6.answers.a}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q6.answers.b}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q6.answers.c}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/Question7')}>
                        <button style={btn}>{qu.q6.answers.d}</button>
                    </div>
                </div>
            </div>
