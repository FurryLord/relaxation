    ...
    return (
        <body style={body}>
            ...
            <div style={block}>
                ...
                <div style={little_box_now} id="b9">9</div>
            ...
            <div style={box}>
                ...
                <div style={answer}>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q9.answers.a}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q9.answers.b}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/GameOver')}>
                        <button style={btn}>{qu.q9.answers.c}</button>
                    </div>
                    <div style={box_answer} onClick={() => navigate('/home/Question10')}>
                        <button style={btn}>{qu.q9.answers.d}</button>
                    </div>
                </div>
            </div>
