...
import { Question1 } from './Questionn1';
import { Question2 } from './Question2';
import { Question3 } from './Question3';
import { GameOver } from './GamrOver';
...
export function Game(){
    ...
    return ( 
        ...
        <body style={body}>
            ...
            <div style={box}>
                <div style={question}>
                    <h3 style={h3}>Are you ready to start the game and test your knowledge?</h3>
                </div>

                <div style={answer}>
                    <div style={box_answer} id="a">
                        <button style={btn} onClick={() => navigate('/home/Question1')}>Start!</button>
                    </div>
